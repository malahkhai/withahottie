"use client";
import { analyticsHostAllowed, CONSENT_KEY, GA_ID, pageGroup, readChoice } from "./model";
...
export function analyticsAllowed() {
  try { return process.env.NEXT_PUBLIC_GA_ENABLED === "true" && analyticsHostAllowed(location.hostname) && readChoice(localStorage.getItem(CONSENT_KEY)) === true; } catch { return false; }
}
